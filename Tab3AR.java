...
public class Tab3AR extends Fragment implements SensorEventListener, LocationListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        arOverlayView = new AROverlayView(this.getActivity());
    ...
    public void requestCameraPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M &&
                this.getActivity().checkSelfPermission(Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
    ...
    public void requestLocationPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M &&
                this.getActivity().checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
    ...
    public void initARCameraView() {
        ...
        if (arCamera == null) {
            arCamera = new ARCamera(this.getActivity(), surfaceView);
        }
    ...
    private void initCamera() {
        ...
        if(numCams > 0){
            try{
                ...
                Toast.makeText(this.getActivity(), "Camera not found", Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private void initLocationService() {
        ...
        try   {
            this.locationManager = (LocationManager) this.getActivity().getSystemService(this.getActivity().LOCATION_SERVICE);
